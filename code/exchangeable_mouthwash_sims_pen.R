one_rep <- function(new_params, current_params) {
  ...
  ash_list$mouthwash_norm <- mouthwash(Y = Y, X = X, num_sv = num_sv,
                                       likelihood = "normal", alpha = 1, scale_var = TRUE,
                                       var_inflate_pen = 0.01)
  ash_list$mouthwash_t <- mouthwash(Y = Y, X = X, num_sv = num_sv,
                                    likelihood = "t", alpha = 1, scale_var = TRUE,
                                    var_inflate_pen = 0.01)
  ash_list$backwash    <- backwash(Y = Y, X = X, num_sv = num_sv, alpha = 1, scale_var = TRUE,
                                   var_inflate_pen = 0.01)
...
saveRDS(cbind(par_vals, sout), "../output/alpha_1_sims_out/sims_out_pen.RDS")
