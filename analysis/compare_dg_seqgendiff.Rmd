...
Notice that the boxplots should be centered about 1 and -1. datamaker is, and has much lower variability. Poisthin is scattered everywhere. This is a subtle bug and I need to figure out what's going on.
```{r}
boxplot(simmat)
abline(h = 1, lty = 2)
abline(h = -1, lty = 2)
